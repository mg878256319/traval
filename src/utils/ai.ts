...
- **每个需要住宿的晚上必须推荐一个具体的酒店**：根据预算匹配酒店档次：
  - 豪华型（人均每晚≥500元）：推荐五星级/奢华度假酒店
  - 舒适型（人均每晚300-500元）：推荐四星级/高端精品酒店
  - 经济型（人均每晚150-300元）：推荐三星级/商务酒店
  - 穷游型（人均每晚<150元）：推荐经济型酒店/青旅/民宿
  必须包含真实酒店名称、每晚价格、推荐理由
...
请返回JSON（不要markdown标记）：
{
  ...
  "dailyPlan": [
    {"day":1,"title":"第1天主题","activities":["上午：...","下午：...","晚上：..."],"meals":["午餐：...","晚餐：..."],"hotel":"酒店名 价格 理由"}
  ],
  "tips": "一句话"
}`
}
